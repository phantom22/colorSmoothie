class colorSmoothie {
  ...
  setGamma(gamma) {
    ...
    if ( typeof gamma === "string" && typeof t.gammas[gamma] !== "undefined" ) {

      t.gamma = t.gammas[gamma];
 ...
 // XYZtoLUV
  ...
  LABcolorMixer(RGBcolorArray) {
    ...
    if ( typeof RGBcolorArray !== "undefined" ) {
      ...
      const LABcolorArray = RGBcolorArray.map( v => t.RGBtoLAB(v) );
